...
async function carregarPergunta() {
  try {
    ...
    const perguntasFiltradas = perguntas.filter(q =>
      ...
      q.topico?.toLowerCase() === "variaveis"          // troque pelo tópico que você quiser
    );
...
function mostrarFimDeJogo(vitoria) {
  ...
  if (vitoria) {
    ...
    localStorage.setItem("emblema_game_variaveis", "true");

    // ✅ Exibe imagem do emblema
    mensagemFinalEl.innerHTML += `
      <br/><strong>Você conquistou o emblema de Variáveis!</strong><br/>
      <img src="/frontend/assets/emblemas/game_variaveis.png"
